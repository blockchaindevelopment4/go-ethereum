...
import (
	...
	"github.com/venusgalstar/go-ethereum/crypto/signify"
	"github.com/venusgalstar/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/venusgalstar/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/venusgalstar/go-ethereum/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/venusgalstar/go-ethereum/core/rawdb", "github.com/venusgalstar/go-ethereum/ethdb/leveldb"},
		{"github.com/venusgalstar/go-ethereum/core/rawdb", "github.com/venusgalstar/go-ethereum/ethdb/pebbledb"},
	}
